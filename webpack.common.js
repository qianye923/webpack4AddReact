...
module.exports = {
  entry: {
    ...
    royal_account_index:
      "./src/pages/netbar/royal_account_index/royal_account_index.js",
    royal_confirm_inform:
      "./src/pages/netbar/royal_confirm_inform/royal_confirm_inform.js",
    royal: "./src/pages/royal/royal_account_index.js"
  },
  output: {
  ...
  plugins: [
    ...
    new AutoWebPlugin("./src/pages/" + MODULE + "/", {
